...
abstract class GreggsTestBaseCatalogueService {
  Future<List<GreggsTestProduct>> fetchCatalogue();
}

class GreggsTestCatalogueService implements GreggsTestBaseCatalogueService {
  @override
  Future<List<GreggsTestProduct>> fetchCatalogue() async {
    return <GreggsTestProduct>[SausageRoll.fromJson(exampleJson)];
  }
}

const Map<String, dynamic> exampleJson = <String, dynamic>{
  "articleCode": "1000446",
  "shopCode": "1234",
